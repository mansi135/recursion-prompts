...
var exponent = function(base, exp) {
	...
	if (exp < 0)
		return exponent(base, exp+1)/base; //how ish it different from (1/base * exponent(base, exp+1))
...
var reverse = function(string) {
 ...
 /*	function reverse (string) {
		...
		var l = string.length;
		for(var i = 0; i < l; i++) {
	  		string = string.slice(1,l-i) + string.charAt(0) + string.slice(l-i,l);
	  	}
...
var palindrome = function(string) {
	...
	if (string.charAt(0).toLowerCase() !== string.charAt(l-1).toLowerCase()) {
		return false;
	}

	var newStr = string.slice(1,l-1);
